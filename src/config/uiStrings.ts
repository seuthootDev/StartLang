...
const EN: Record<UiKey, string> = {
  ...
  languageHubLead: 'Start with Basic — the must-memorize steps for beginners.',
  overview: 'Overview',
...
export const UI_STRINGS: Record<LangCode, Partial<Record<UiKey, string>>> = {
  ...
  ko: {
    ...
    languageHubLead: 'Basic부터 시작하세요. 외우기 귀찮지만 꼭 필요한 기초 목차입니다.',
    overview: '개요',
  ...
  ja: {
    ...
    languageHubLead: 'Basicから始めましょう。覚えるのは面倒でも必須の基礎メニューです。',
    overview: '概要',
  ...
  zh: {
    ...
    languageHubLead: '从 Basic 开始——初学者必须记住的基础目录。',
    overview: '概览',
    roundResult: '第 {n} 轮结果',
  ...
  fr: {
    ...
    languageHubLead: 'Commencez par Basic — l’essentiel à mémoriser.',
    overview: 'Aperçu',
  ...
  es: {
    ...
    languageHubLead: 'Empieza por Basic — lo esencial que hay que memorizar.',
    overview: 'Resumen',
  ...
  de: {
    ...
    languageHubLead: 'Starte mit Basic — das, was man auswendig brauchen wird.',
    overview: 'Übersicht',
  ...
  ru: {
    ...
    languageHubLead: 'Начните с Basic — то, что скучно, но нужно запомнить.',
    overview: 'Обзор',
