...
export const UI_STRINGS: Record<LangCode, Partial<Record<UiKey, string>>> = {
  ...
  it: {
    appName: 'LangStart',
    tagline: 'Le prime parole. Ogni lingua.',
    chooseTarget: 'Scegli una lingua da studiare',
    comingSoon: 'Presto',
    back: 'Indietro',
    asLearner: 'La tua lingua',
    hearPronunciation: 'Pronuncia',
    correct: 'Corretto!',
    wrong: 'Non proprio',
    next: 'Avanti',
    score: 'Punteggio',
    restart: 'Ricomincia',
    noMoreQuestions: 'Hai finito questo set!',
    categories: 'Categorie',
    startCategory: 'Inizia il quiz',
    emptyCategory: 'Non ci sono ancora carte in questa categoria.',
    languageHubLead:
      'Parti dalle basi — i passi da memorizzare all’inizio.',
    languageHubMenuHint:
      'Su mobile, tocca le tre linee in alto a sinistra per aprire il menu.',
    overview: 'Panoramica',
    roundResult: 'Risultati del round {n}',
    perfectRound: 'Perfetto — tutto corretto!',
    retryMissed: 'Ripeti {n} errori',
    missedSummary:
      '{correct} corretti · {missed} sbagliati. Ripeti solo quelli sbagliati.',
    yourAnswer: 'Tu',
    correctAnswer: 'Risposta',
    tapToContinue: 'Tocca per continuare',
    enterToContinue: 'Invio o tocca per continuare',
    typeCharacter: 'Digita il suono',
    checkAnswer: 'Controlla',
    openTable: 'Tabella',
    close: 'Chiudi',
    vocabGrade: 'Classe',
    vocabMode: 'Modalità quiz',
    vocabModeReading: 'Lettura',
    vocabModeMeaning: 'Significato',
    vocabCount: 'Domande',
    jlptHubLead:
      'Un percorso di vocabolario più ampio — separato dalle basi brevi. Scegli un livello, poi un giorno (~20 parole).',
    jlptHubMeta: '{days} giorni · {words} parole',
    jlptBackToHub: 'Tutti i livelli JLPT',
    jlptPrevDay: 'Giorno precedente',
    jlptNextDay: 'Giorno successivo',
    contributeTitle: 'Aiuta a costruire LangStart',
    contributeLead:
      'Open source — correggi suoni, traduzioni o tabelle, o aiuta ad aggiungere una lingua.',
    contributeCta: 'Vedi su GitHub',
  },
  ru: {
    appName: 'LangStart',
